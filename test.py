...
with open ("/home/breno/.ot/client_data/wallet.xml", "r") as myfile:
    data=myfile.read()    

data = data+'\n\n'
resultado = otapi.OTAPI_Basic_Decode(data, True)

print otapi.OTAPI_Basic_GetNymCount()

otapi.OTAPI_Basic_AppShutdown()
#otapi.OTAPI_Basic_SetWallet(resultado)
